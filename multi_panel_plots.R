...
#=============================================================================
# COMMENTS (as a big quoted block)

COMMENTS <- "

With R, when you print plots to PDF or SVG files, they are created as vector
graphics, which don't have a given resolution (see
https://en.wikipedia.org/wiki/Vector_graphics). In other words, you can 'zoom
in' forever and it won't get blocky. They are printed (or displayed) at the
maximum resolution of the printer or display device.
